...
Blub_fnc_garage = {
  ...
  if !(isNull(uiNamespace getVariable ["BIS_fnc_arsenal_cam",objNull]))
    exitwith { "Garage Viewer is already running" call bis_fnc_logFormat;};
    {deleteVehicle _x;}
  ...
  with uiNamespace do {
  	...
  	waitUntil
    {sleep 0.25; isNull (uiNamespace getVariable ["BIS_fnc_arsenal_cam",objNull])};
    ...
    deleteVehicle _pad;
      ...
      deleteVehicle _x;
  		...
  		_new_veh setVehicleLock "UNLOCKED";
  		_count = 0;
  			       {
